Public Class FormMasa
    ...
    Public Sub New()
        ...
        ComboBox1.Items.AddRange(masa.Medidas())
        ComboBox1.SelectedIndex = 0
        ComboBox2.Items.AddRange(masa.Medidas())
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            If TextBox1.Text IsNot "" Then
                TextBox2.Text = masa.Convertir(Double.Parse(TextBox1.Text), ComboBox1.Text, ComboBox2.Text)
            End If
