Public Class FormTiempo
    Dim tiempo As Tiempo = New Tiempo()
    Public Sub New()
        ...
        ComboBox1.Items.AddRange(tiempo.Medidas())
        ComboBox1.SelectedIndex = 0
        ComboBox2.Items.AddRange(tiempo.Medidas())
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            If TextBox1.Text IsNot "" Then
                TextBox2.Text = tiempo.Convertir(Double.Parse(TextBox1.Text), ComboBox1.Text, ComboBox2.Text)
            End If
